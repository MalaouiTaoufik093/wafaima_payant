...
@Transactional
@CrossOrigin("*")
public class Contrat_service2 {
	private final WAFAIMA_ContratsRpository contrarrepository;
	private HSSFWorkbook workbook;

	@Autowired
	public Contrat_service2(WAFAIMA_ContratsRpository contrarrepository) {
...
//                for(int aw=0;aw<1 ; aw++){   
			...
			table2.addCell(new Paragraph(client.getCategorie_vehicule(), tableBody_véhicule));
...
//                emailValue.setPaddingLeft(10);
			...
			Paragraph paragraph4 = new Paragraph(
					...
					+ ".....................................                                 Prime à régler :  OFFERT PAR  : MATU ASSURANCE",
					mainFont3);
